...
template <int kHeadDim_, int kBlockM_, int kBlockN_, int kNWarps_, typename elem_type = cutlass::half_t, 
          bool Share_Q_K_smem_ = false, bool Is_Q_in_regs_ = false>
struct Flash_kernel_traits {
    ...
    using TiledMMA = TiledMMA<typename MMA_Atom_Arch, Layout<Shape<Int<kNWarps>, _1, _1>>,  typename ValLayoutMNK>; 
