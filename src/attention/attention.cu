...
#include "attention/fmha.h"
#include "attention/static_switch.h"
#include "tensor.h"

inline Launch_params<FMHA_fprop_params> set_fmha_fwd_params(Tensor<half> *Q, Tensor<half> *K, Tensor<half> *V, Tensor<half> *O,
...
inline void run_fmha_fwd(Launch_params<FMHA_fprop_params> &launch_params) {
...
void attention(Tensor<half> *Q, Tensor<half> *K, Tensor<half> *V, Tensor<half> *O, Tensor<int> *cu_seq_q,
