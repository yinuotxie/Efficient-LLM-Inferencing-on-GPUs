...
#include "attention_v2/flash.h"
#include "attention_v2/static_switch.h"
#include "tensor.h"

#define M_LOG2E 1.4426950408889634074  // log_2 e

inline Flash_fwd_params set_mha_fwd_params(Tensor<half> *Q, Tensor<half> *K, Tensor<half> *V, Tensor<half> *O,
...
inline void run_mha_fwd(Flash_fwd_params &params, cudaStream_t stream) {
    FWD_HEADDIM_SWITCH(params.d, [&] { run_mha_fwd_<cutlass::half_t, kHeadDim>(params, stream); });
}

void attention_v2(Tensor<half> *Q, Tensor<half> *K, Tensor<half> *V, Tensor<half> *O, Tensor<int> *cu_seq_q,
